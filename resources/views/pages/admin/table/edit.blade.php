            ...
            <div class="card mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-8">
                        ...
                        <img class="rounded mt-3" id="image-product" width="180" src="{{ url('assets/imgs/products') }}/{{ $product->img }}" alt="" />
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row gx-2">
                        <div class="row mb-5">
                            ...
                            <div class="col-8">
                                <input type="text" placeholder="Contoh: Sepatu Pria (Jenis/Kategori Produk) + Tokostore (Merek) + Kanvas Hitam (Keterangan)" class="form-control {{ $errors->has('name') ? 'has-error' : '' }}" name="name" onchange="checkValue()" id="product_name" value="{{ $product->name }}"/>
                                @error('name')
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                <select class="form-select" name="exclusive">
                                    ...
                                    <option value="0" @if('0' == $product->exclusive) selected @endif>No Exclusive</option>
                                    <option value="1" @if('1' == $product->exclusive) selected @endif>Best Sellers</option>
                                    <option value="2" @if('2' == $product->exclusive) selected @endif>New Items</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                ...
                                Edisi terbatas dari Tokostore dengan model baru dan trendy untukmu. Didesain untuk bisa dipakai dalam berbagai acara. Sangat nyaman saat dipakai sehingga dapat menunjang penampilan dan kepercayaan dirimu. Beli sekarang sebelum kehabisan!">{{ $product->short_desc }}</textarea>
                            </div>
                        </div>
                </div>
            </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                ...
                                <input placeholder="Masukkan Harga" type="text" name="disc_price" class="form-control" id="rupiah_disc_price" aria-describedby="basic-addon1" value="{{ $product->disc_price }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp</span>
                                <input placeholder="Masukkan Harga" type="text" name="price" class="form-control" id="rupiah_price" aria-describedby="basic-addon1" value="{{ $product->price }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                <input placeholder="Masukkan Harga" type="text" name="disc" class="form-control" id="rupiah_disc_price" aria-describedby="basic-addon1" value="{{ $product->disc }}"/>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Aladin Mall" name="aladin_mall" class="form-control" id="product_name" value="{{ $product->aladin_mall }}" />
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Tokopedia" name="tokopedia" class="form-control" id="product_name" value="{{ $product->tokopedia }}"/>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Shopee" name="shopee" class="form-control" id="product_name" value="{{ $product->shopee }}"/>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Lazada" name="lazada" class="form-control" id="product_name" value="{{ $product->lazada }}"/>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Blibli" name="blibli" class="form-control" id="product_name" value="{{ $product->blibli }}"/>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <input type="text" placeholder="Masukkan Link Produk Bukalapak" name="bukalapak" class="form-control" id="product_name" value="{{ $product->bukalapak }}"/>
                        </div>
                    </div>
                </div>
            </div>
