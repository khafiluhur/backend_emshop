            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="Product Name" class="form-control" name="name" id="product_name" />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea placeholder="Short Description"  class="form-control" name="short_desc" rows="4"></textarea>
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Full description</label>
                            <textarea placeholder="Full Description" class="form-control" name="full_desc" rows="4"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <div class="row gx-2">
                                        <input placeholder="Rp" type="text" name="price" class="form-control" id="rupiah_price"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input placeholder="Rp" type="text" name="disc_price" class="form-control" id="rupiah_disc_price" />
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    <label class="form-label">Discount</label>
                                    <input placeholder="%" type="text" name="disc" class="form-control" />
                                </div>
                            </div>
                        </div>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="https://aladinmall.misteraladin.com/" name="aladin_mall" class="form-control" id="product_name" />
                        </div>
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Tokopedia</label>
                            <input type="text" placeholder="https://www.tokopedia.com/" name="tokopedia" class="form-control" id="product_name" />
                        </div>
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Shopee</label>
                            <input type="text" placeholder="https://www.shopee.com/" name="shopee" class="form-control" id="product_name" />
                        </div>
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Lazada</label>
                            <input type="text" placeholder="https://www.lazada.com/" name="lazada" class="form-control" id="product_name" />
                        </div>
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Blibli</label>
                            <input type="text" placeholder="https://www.blibli.com/" name="blibli" class="form-control" id="product_name" />
                        </div>
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Bukalapak</label>
                            <input type="text" placeholder="https://www.bukalapak.com/" name="bukalapak" class="form-control" id="product_name" />
                        </div>
                </div>
            </div>
            <!-- card end// -->
